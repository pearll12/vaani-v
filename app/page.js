...
function FIcon({ icon: Icon, size = 24, color, bg, dur = 3 }) {
  return (
    <motion.div animate={{ y: [0, -5, 0] }}
      ...
      style={{ width: size * 2.2, height: size * 2.2, borderRadius: size * 0.65,
...
function PersonFig({ color = P.primary, flip = false, delay = 0 }) {
  return (
    <motion.div animate={{ y: [0, -6, 0] }}
      ...
      <div style={{ width: 18, height: 18, borderRadius: "50%", background: "#FDDCB5",
...
function CartFig() {
  return (
    <motion.div animate={{ x: [-8, 8, -8], rotate: [-2, 2, -2] }}
      ...
      <div style={{ position: "absolute", bottom: 10, left: 4, width: 32, height: 18,
        background: P.primary, borderRadius: "2px 2px 6px 6px", boxShadow: `inset -3px -3px 0 ${P.primaryD}` }}>
        <div style={{ position: "absolute", top: -5, left: 4, width: 8, height: 8,
          background: P.sage, borderRadius: 3, transform: "rotate(10deg)" }} />
        <div style={{ position: "absolute", top: -7, right: 4, width: 7, height: 10,
          background: P.amber, borderRadius: 3, transform: "rotate(-5deg)" }} />
      </div>
      <div style={{ position: "absolute", bottom: 26, left: 8, width: 12, height: 10,
        border: `2.5px solid ${P.primaryD}`, borderBottom: "none", borderRadius: "6px 6px 0 0" }} />
      <motion.div animate={{ rotate: 360 }} transition={{ repeat: Infinity, duration: 1.5, ease: "linear" }}
        style={{ position: "absolute", bottom: 2, left: 8, width: 8, height: 8,
          borderRadius: "50%", background: "#5C3D2E", border: `2px solid ${P.amber}` }} />
      <motion.div animate={{ rotate: 360 }} transition={{ repeat: Infinity, duration: 1.5, ease: "linear" }}
        style={{ position: "absolute", bottom: 2, right: 6, width: 8, height: 8,
          borderRadius: "50%", background: "#5C3D2E", border: `2px solid ${P.amber}` }} />
    </motion.div>
  );
}
    ...
    <motion.nav initial={{ y: -60, opacity: 0 }} animate={{ y: 0, opacity: 1 }}
      ...
      <div style={{ display: "flex", gap: 10 }}>
        <motion.a href="/login" whileHover={{ background: P.surface }}
          style={{ padding: "9px 20px", borderRadius: 11, fontSize: 13, fontWeight: 600,
            color: P.text, textDecoration: "none", border: `1px solid ${P.borderM}`,
            transition: "background 0.2s" }}>Login</motion.a>
        <motion.a href="/signup" whileHover={{ scale: 1.04, boxShadow: `0 8px 24px ${P.primary}44` }}
          whileTap={{ scale: 0.97 }}
          style={{ padding: "9px 22px", borderRadius: 11, fontSize: 13, fontWeight: 700,
...
function PhoneIllustration() {
  ...
  return (
    <motion.div animate={{ y: [0, -10, 0] }}
      ...
      style={{ width: 280, background: P.card, borderRadius: 36,
      ...
      <div style={{ background: "#075E54", padding: "10px 16px", display: "flex", alignItems: "center", gap: 10 }}>
        <div style={{ width: 36, height: 36, borderRadius: "50%", background: P.wa,
      ...
      <div style={{ background: "#F5EDE5", padding: "12px 10px", minHeight: 320,
                ...
                {m.voice ? (
                  <div style={{ display: "flex", alignItems: "center", gap: 6 }}>
                    <motion.div animate={{ scale: [1, 1.2, 1] }} transition={{ repeat: Infinity, duration: 0.9 }}
                      style={{ width: 28, height: 28, borderRadius: "50%", background: P.sage,
                        display: "flex", alignItems: "center", justifyContent: "center" }}>
        ...
        {typing && (
          <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }}
            style={{ display: "flex", gap: 4, padding: "8px 12px", background: P.card,
      ...
      <div style={{ background: "#EDE5DC", padding: "8px 12px", display: "flex", alignItems: "center", gap: 8 }}>
        ...
        <div style={{ width: 34, height: 34, borderRadius: "50%", background: P.sage,
          display: "flex", alignItems: "center", justifyContent: "center" }}>
    ...
    <div ref={ref} style={{ position: "relative", width: "100%", height: 380 }}>
      ...
      {chaosItems.map((item, i) => (
        <motion.div key={i} initial={{ opacity: 0, scale: 0, rotate: item.rot * 2 }}
          ...
          <div style={{ padding: "6px 12px", borderRadius: 12, background: item.bg,
...
function HeroContent() {
  return (
    <section style={{ height: "100%", background: P.bg, display: "flex", alignItems: "center",
      ...
      <div style={{ maxWidth: 1200, margin: "0 auto", width: "100%", display: "grid",
        ...
        <div>
          <motion.h1 initial={{ opacity: 0, y: 24 }} animate={{ opacity: 1, y: 0 }}
            ...
            style={{ fontSize: "clamp(36px, 5vw, 60px)", fontWeight: 900, lineHeight: 1.08,
              letterSpacing: "-0.03em", color: P.text, margin: "0 0 20px" }}>
            Orders are coming.
            <br />
            <span style={{ background: `linear-gradient(135deg, ${P.primary}, ${P.primaryD})`,
          ...
          <motion.div initial={{ opacity: 0, y: 16 }} animate={{ opacity: 1, y: 0 }}
            ...
            <motion.a href="/login" whileHover={{ scale: 1.05, boxShadow: `0 12px 32px ${P.primary}55` }}
              whileTap={{ scale: 0.97 }}
              style={{ padding: "15px 32px", borderRadius: 14, fontSize: 16, fontWeight: 800,
                background: `linear-gradient(135deg, ${P.primary}, ${P.primaryD})`,
          ...
          <div style={{ display: "flex", flexDirection: "column", gap: 14 }}>
            {problems.map((p, i) => (
              <Reveal key={i} delay={i * 0.1}>
                <motion.div whileHover={{ x: 6 }} style={{ display: "flex", gap: 16,
      ...
      <div style={{ display: "flex", flexDirection: "column", alignItems: "center" }}>
        ...
        {!isLast && (
          <motion.div initial={{ scaleY: 0 }} animate={inView ? { scaleY: 1 } : {}}
            ...
            style={{ width: 2, height: 36, background: `linear-gradient(${color}, ${color}22)`,
      ...
      <div style={{ maxWidth: 1100, margin: "0 auto", display: "grid",
        ...
        <Reveal delay={0.2} x={30} y={0}>
          <motion.div animate={{ y: [0, -8, 0] }} transition={{ repeat: Infinity, duration: 5, ease: "easeInOut" }}
            ...
            <div style={{ background: P.card, borderRadius: 24, boxShadow: P.shadowL,
              ...
              <div style={{ padding: "20px 24px" }}>
                <div style={{ padding: "12px 14px", background: P.sageL, borderRadius: 12,
                ...
                <div style={{ display: "flex", gap: 10, marginTop: 20 }}>
                  {[{ label: "Invoice Sent", icon: FileText, color: P.sage, bg: P.sageL },
                    ...
                    <motion.div key={i} initial={{ scale: 0 }} whileInView={{ scale: 1 }}
                      ...
                      style={{ flex: 1, padding: "10px", borderRadius: 10, background: a.bg,
  ...
  return (
    <motion.div initial={{ opacity: 0, y: 24 }} whileInView={{ opacity: 1, y: 0 }}
      ...
      <motion.div animate={hov ? { scale: 1.15, rotate: 10, y: -4 } : { scale: 1, rotate: 0, y: 0 }}
        style={{ width: 56, height: 56, borderRadius: 18, background: bg,
...
function ContactUs() {
  ...
  const inputStyle = { width: "100%", padding: "14px 16px", borderRadius: 12, border: `1px solid ${P.border}`,
        ...
        <Reveal delay={0.1}>
          <form onSubmit={handleSubmit} style={{ background: P.card, borderRadius: 24, padding: "40px 36px",
            ...
            <motion.button type="submit" whileHover={{ scale: 1.02, boxShadow: `0 8px 24px ${P.primary}44` }}
              whileTap={{ scale: 0.98 }}
              style={{ width: "100%", padding: "16px 32px", borderRadius: 14, border: "none",
      ...
      <AnimatePresence>
        {showLabel && (
          <motion.div initial={{ opacity: 0, x: -10 }} animate={{ opacity: 1, x: 0 }}
            exit={{ opacity: 0, x: -10 }}
            style={{ position: "fixed", bottom: 38, right: 94, zIndex: 999,
...
/* ═══════════════ FOOTER ═══════════════ */
function Footer() {
  const linkStyle = { display: "block", fontSize: 13, color: "rgba(255,255,255,0.55)",
    ...
    <footer style={{ background: "#2C1E16", color: "#fff", padding: "64px 40px 28px" }}>
      <div style={{ maxWidth: 1100, margin: "0 auto" }}>
        <div style={{ display: "grid", gridTemplateColumns: "2fr 1fr 1fr 1fr", gap: 40, marginBottom: 48 }}>
          ...
          <div>
            <h4 style={{ fontSize: 12, fontWeight: 700, marginBottom: 18, color: P.amber,
              letterSpacing: "0.08em" }}>PRODUCT</h4>
          ...
          <div>
            <h4 style={{ fontSize: 12, fontWeight: 700, marginBottom: 18, color: P.amber,
              letterSpacing: "0.08em" }}>COMPANY</h4>
          ...
          <div>
            <h4 style={{ fontSize: 12, fontWeight: 700, marginBottom: 18, color: P.amber,
              letterSpacing: "0.08em" }}>SUPPORT</h4>
